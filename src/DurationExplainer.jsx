  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", color: C.text }}>
      ...
      <div ref={containerRef} style={{ maxWidth: 800, margin: "0 auto", padding: "28px 32px 80px" }}>
        ...
        <P>
          Whichever period you choose, the baseline data must cover the full range of conditions the building will experience during the reporting period. For a weather-dependent building, this typically means a full year — capturing the heating season, cooling season, and shoulder months. This is sometimes called a "coverage factor" — typically requiring at least 90% of operating conditions represented.
        </P>
        <P>
