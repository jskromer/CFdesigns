      ...
      <div ref={containerRef} style={{ maxWidth: 800, margin: "0 auto", padding: "28px 32px 80px" }}>
        ...
        {activeCase === 1 && (
          <div>
            ...
            <P>
              The server room load (8,200 kWh/month) is a <strong>non-routine event</strong> — a change in the facility that is independent of the retrofit and independent of weather. Standard M&V practice requires that we identify and adjust for it.
            </P>
