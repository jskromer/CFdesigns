...
function ComparisonTable() {
  const rows = [
    ...
    { dim: "Model type", wf: "Statistical regression or calibrated simulation", ri: "Key parameter measurement or all-parameter monitoring" },
    ...
    <div style={{ background: C.bg, minHeight: "100vh", color: C.text }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "28px 32px 80px" }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          {[
            { id: "whole", label: "Whole Facility", color: C.blue },
            { id: "isolation", label: "Retrofit Isolation", color: C.rose },
          ].map(m => (
        ...
        {/* Boundary × Model Form */}
        <h2 style={{ fontFamily: "'IBM Plex Sans'", fontSize: 20, fontWeight: 700, marginBottom: 14, marginTop: 32 }}>Boundary × Model Form</h2>
        <P>
        ...
        <P>
          This course holds the boundary constant at <strong>whole facility</strong> and teaches you to execute the model form and duration dimensions with rigor. That means utility meter data, statistical and physical models, and the full weight of non-routine adjustments.
        </P>
        <P>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          {[
            { title: "IPMVP Reference", url: "https://mv-course.vercel.app", desc: "How these approaches map to IPMVP Options A–D" },
            { title: "Industry Measurement Protocols", url: "https://www.ashrae.org/technical-resources/bookstore/ashrae-guideline-14-2014", desc: "ASHRAE Guideline 14: measurement approaches" },
