      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "32px 32px 80px" }}>
        ...
        <Section title="Statistical vs. Physical: When to Use Which" color={C.teal}>
          ...
          <Callout color={C.teal} label="The practitioner's decision">
            The choice isn't statistical <em>or</em> physical. It's about matching the model to the question. A whole-building statistical model answers "how much energy did we avoid?" A physics-based simulation answers "how much energy <em>would</em> we use under conditions we've never seen?"
          </Callout>
        </Section>
        ...
        <div style={{ padding: "16px 20px", background: C.surface, border: `1px solid ${C.border}`, borderRadius: 8 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            {[
              ["Industry measurement protocols", "https://www.ashrae.org/technical-resources/bookstore/ashrae-guideline-14-2023-measurement-of-energy-demand-and-water-savings", "Measurement protocols for statistical and simulation-based M&V approaches"],
